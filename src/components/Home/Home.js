...
class Home extends Component{
    ...
    handleScroll(e){
        ...
        e.deltaY > 0 ? ( this.state.scroll < 2 ? this.setState({
            scroll: newScroll + 1
        }) : null) :
                    ...
                    <div className={this.state.scroll === 1 ? "papah papahgo" : "papah"}>
                        ...
                        <div className="topholder">
                            <div className="toptext">
                                <h4>Hey. We know you're hungry but you can't decide what you want to eat. It's tough. We've all been there and we're here to help with that. Making such an impossible decision on an empty stomach is something nobody should have to suffer through alone. Now you don't have to. Help us help you, scroll down to find out your options.</h4>
                            </div>
                        </div>
                    </div>
                        <div className={this.state.scroll === 1 ? "maincardshow" : ( this.state.scroll === 2 ? "maincardgo" : "maincard")}>
                            <div className="navbar">
                                <a href="/#/home"><div className="navhome"><h1>G</h1></div></a>
                                <div className="navlinks">
                                    <a href="/#/out"><div>Eat Out</div></a>
                        ...
                        <div className={this.state.scroll === 2 ? "secondcardshow" : "secondcard"}>
                        <div className="navbar">
                            <a href="/#/home"><div className="navhome"><h1>G</h1></div></a>
                            <div className="navlinks">
                                <a href="/#/out"><div>Eat Out</div></a>
