const initialState = {
    ...
    randDrink: ["martini", "appletini", "cosmo", "margarita", "frozen margarita", "strawberry margarita", "old fashioned", "mojito", "daiquri", "strawberry daiquiri", "manhattan", "negroni", "bloody mary", "spicy bloody mary", "mai tai", "mint julep", "moscow mule", "dublin mule", "espresso martini", "irish coffee", "long island", "gin and tonic", "pina colada", "whiskey sour", "white russian", "dark n stormy", "tequila sunrise", "sex on the beach", "bellini", "sangria", "screwdriver", "fireball", "mimosa"],
    recipesList: [],
    selectedRecipeID: "",
    selectedRecipe: {}
}
